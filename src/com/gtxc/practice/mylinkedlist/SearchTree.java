...
/**
 * Created by gt at 12:37 AM on Wednesday, November 11, 2020.
 * Project: practice.
 */
...
public class SearchTree implements NodeList {
    ...
    public boolean addItem(ListItem newItem) {
        ...
        while (currentItem != null) {
            ...
            if (comparison < 0) {
                ...
                if (currentItem.next() != null) {
                    ...
                    // there is nı node to the right, so add at this point
        ...
        // we cannot actually get here, but Java complains if there is no return
        return false;
    }
